...
{
    public partial class NWConsole_96_medContext : DbContext
    {
        public NWConsole_96_medContext()
        {
        }

        public NWConsole_96_medContext(DbContextOptions<NWConsole_96_medContext> options)
            : base(options)
        {
        }
